...
#define HT_UVC_PROD               0x01    /* EP 1 OUT */
#define HT_UVC_CONS               0x81    /* EP 1 IN */
#define HT_GPU_PROD               0x02    /* EP 2 OUT */
#define HT_GPU_CONS               0x82    /* EP 2 IN */
...
#define HT_UVC_PROD_SOCKET        CY_U3P_UIB_SOCKET_PROD_1    //对应CY_U3P_UIB_SOCKET_CONS_1
#define HT_UVC_CONS_SOCKET        CY_U3P_UIB_SOCKET_CONS_2    //对应CY_U3P_UIB_SOCKET_PROD_2
#define HT_GPU_PROD_SOCKET        CY_U3P_UIB_SOCKET_PROD_3    //对应CY_U3P_UIB_SOCKET_CONS_3
#define HT_GPU_CONS_SOCKET        CY_U3P_UIB_SOCKET_CONS_4    //对应CY_U3P_UIB_SOCKET_PROD_3
